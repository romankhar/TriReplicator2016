...
/**
 * Encryption related tools. Used by database manager before storing and when retrieving data from the DB
 * 
 * @author Roman Kharkovski, http://kharkovski.blogspot.com
 */
public class SecurityTools {

	private static final java.util.logging.Logger log = Utils.getLogger(SecurityTools.class.getName());

	/**
	 * For test purpose one could use these values:
	 */
